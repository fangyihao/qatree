...
def test_parallel_embedding(model_parallel_size):
    ...
    set_random_seed(seed)
    embedding_parallel = layer.ParallelEmbeddings(
    ...
    set_random_seed(seed)
    embedding_vocab_parallel = layer.VocabParallelEmbeddings(
        vocab_size, hidden_size, init_method=init.normal_).cuda()
...
def test_initialize_affine_weight(model_parallel_size):
    ...
    set_random_seed(seed)
    layer._initialize_affine_weight(weight, output_size, input_size,
